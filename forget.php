...
<body id="body">
  ...
  ============================-->
  <section class="box">
	<form action="http://localhost/BookBig/forget2.php" method="POST">
    <div id="login" class="textcenter">
		<h3 id="italic">Forget Password</h3>
	...
	<!-- php begins here -->
	<?php
	/* if the submit username and email is match with database then header( "Location:forget2.php" )*/
	?>
  </section>
