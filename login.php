...
<body id="body">
  ...
  <!-- Content -->
  <section class="box">
	<form action="http://localhost/BookBig/php/login.php" method="POST">
    <div id="login" class="textcenter">
		<h3 id="italic"> Login</h3>
		<label>Username:</label>
		<input type="text" name="username"> <br>
		<label> Password:&nbsp </label>
		<input type="password" name="password"> <br>
		<button type="submit" name='submit' value="submit">Login</button><br>
		<a id="italic" style="color:white;" href="forget.php"> Forgot your password</a><br>
		<a id="italic" style="color:white;" href="signup.php"> Create an account</a>
	</div>
	</form>
