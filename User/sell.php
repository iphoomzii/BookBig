...
<!-- Content -->
<form action=<?php $uid=$_GET['uid']; echo  'http://localhost/BookBig/php/selling.php?uid='.$uid;?> method = "POST">
  <section class="function">
	<div id="info" class="textcenter">
	
	<h2 id="italic"> Sell </h2>
	<label>Please fill in deatils about the book</label><br>
	
	<label> Title: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </label>
	<input type="text" name="title"> <br>
	
	<label> Author: &nbsp&nbsp&nbsp</label>
	<input type="text" name="author"> <br>
	
	<label> Publisher: </label>
	<input type="text" name="publisher"> <br>
	
	<label> Genre: &nbsp&nbsp&nbsp&nbsp</label>
	<input type="text" name="genre"> <br>
	
	<label> Pages: &nbsp&nbsp&nbsp&nbsp</label>
	<input type="text" name="pages"> <br>
	
	<label> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp Price: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label> 
	...
	<button type="submit" name='submit' value="submit">Post</button><br>
	
	
	</div>
	<div id="bookdetail" class="textcenter">
	<h2 id="italic"italic"> BookDetails</h2>
