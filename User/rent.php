...
<!-- Content -->
<form action=<?php $uid=$_GET['uid']; echo  'http://localhost/BookBig/php/renting.php?uid='.$uid;?> method = "POST">
  <section class="function" style="text-align: center;">
	<div id="info" class="textcenter">
  
	
	<h2 id="italic"> Rent </h2>
	<label>Please fill in book name</label><br>
  ...
  <br>
	...
	<button type="submit" name='submit' value="submit">Search</button><br>
