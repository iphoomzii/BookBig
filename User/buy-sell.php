...
<!--
  <section id="intro">
    ...
    <div class="intro-content">
      ...
      <div>
        <button onclick="window.location.href='buy.php'"  class="btn-get-started scrollto">Buy</button><br>
        <button onclick="window.location.href='sell.php'" class="btn-projects scrollto">Sell</button>
      </div>
    ...
    <section id="services">
      ...
      <?php
      echo "<a href='http://localhost/BookBig/User/sell.php?uid=$uid'>";
      ?>
			...
			<?php
      echo "<a href='http://localhost/BookBig/User/buy.php?uid=$uid'>";
      ?>
